...
export const ReportCardView: React.FC<Props> = ({ student, school }) => {
  const [selectedExamKey, setSelectedExamKey] = useState<string>('sa1');
  const [template, setTemplate] = useState<TemplateMode>('modern');

  const report: ExamReport = MOCK_REPORTS[selectedExamKey] || MOCK_REPORTS['sa1'];
    ...
    <div className="space-y-4 pb-20">
      ...
      >
        ...
        <div className="text-center pb-3 border-b border-white/20">
          <h2 className="font-black text-base uppercase tracking-wider">{school.name}</h2>
