...
studentRoutes.put('/:id', async (c) => {
  ...
  db.update(schema.students)
    .set({
      ...
      nicNo: nicNo !== undefined ? nicNo : existing.nicNo,
      address: address !== undefined ? address : existing.address,
      city: city !== undefined ? city : existing.city,
      state: state !== undefined ? state : existing.state,
      pincode: pincode !== undefined ? pincode : existing.pincode,
      admissionDate: admissionDate !== undefined ? admissionDate : existing.admissionDate,
      fatherOccupation: fatherOccupation !== undefined ? fatherOccupation : existing.fatherOccupation,
      motherOccupation: motherOccupation !== undefined ? motherOccupation : existing.motherOccupation,
      previousSchool: previousSchool !== undefined ? previousSchool : existing.previousSchool,
